...
import GuestSearch from '@/Components/Hotel/GuestSearch';
                        ...
                        <CardContent>
                            <form onSubmit={submit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <GuestSearch
                                        guests={guests}
                                        selectedGuest={data.guest_id}
                                        onGuestSelect={(val) => setData('guest_id', val)}
                                        placeholder="Buscar hóspede por nome, documento, telefone ou email..."
                                    />
